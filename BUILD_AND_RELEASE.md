...
`v0.5.0-alpha.1` is the current public prerelease. Its unchanged portable ZIP is `Len-Portable-0.5.0-alpha.1.zip` (43,700,470 bytes; SHA-256 `F5B4DD956481294BD136345F5C6F02D708943A37851DD80B191A1A987CC0717D`). Tag `v0.5.0-alpha.1` targets `1fe8af87fe2fb22e73de474a70708f25119e491a`; the separate build-source commit is `9e556e9080455aaa66cb398d37bd7fa8082ba5b1`. The [release record](docs/releases/v0.5.0-alpha.1.md) contains its exact-candidate and publication evidence. The local ZIP remains ignored and must not be committed.
